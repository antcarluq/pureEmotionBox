...
class Customizer_Check_Sortable extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'ckecksorter', get_template_directory_uri() . '/customizer/assets/ckecksorter.css', '1.0' );
		wp_enqueue_script( 'ckecksorter', get_template_directory_uri() . '/customizer/assets/ckecksorter.js', array( 'jquery', 'jquery-ui-sortable', 'customize-controls' ), '1.0' );
	}
